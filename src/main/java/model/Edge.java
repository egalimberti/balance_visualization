...
public class Edge {
    ...
    public String toString() {
        ...
        if ((source.getCluster() == target.getCluster()) && Math.abs(source.getOriginalY() - target.getOriginalY()) == 1) {
            consecutive = true;
        }

        return "{\"id\": \"" + id + "\",\"source\": \"" + source_id + "\", \"target\": \"" + target_id + "\", \"sign\":\"" + sign + "\", \"consecutive\":" + consecutive + "}";
    }
}
